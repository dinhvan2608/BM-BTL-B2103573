      ...
      <div class="main">
        <div class="container">
          ...
          <div class="row">
              ...
              <div class="card mb-3 card-1">
                ...
                <div class="card-body">
                  ...
                  <div class="inner-order">
                    Đã mượn: <b>{{ information.book.order }}</b>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-6">
              <div class="card mb-3 card-2">
                <div class="card-header">Nhà xuất bản</div>
                <div class="card-body">
                  <div class="inner-quantity mb-3">
          ...
          <div class="row">
            <div class="col-6">
              <div class="card mb-3">
                <div class="card-header">Tài khoản Admin</div>
                <div class="card-body">
                  <div class="inner-quantity mb-3">
            ...
            <div class="col-6">
              <div class="card mb-3">
                <div class="card-header">Tài khoản Client</div>
                <div class="card-body">
                  <div class="inner-quantity mb-3">
