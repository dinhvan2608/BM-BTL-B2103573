    ...
    <div class="body">
      <div class="sider">
        <div class="inner-menu">
          <ul>
            <li><router-link to="/admin/dashboard">Tổng quan</router-link></li>
            <li>
              <router-link to="/admin/books">Danh sách sản phẩm</router-link>
            </li>
            <li>
            ...
            <li>
              <router-link to="/admin/orders">Danh sách mượn sách</router-link>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="main">
        <h1 class="mb-4" v-if="user._id">Cập nhật người dùng</h1>
        <h1 class="mb-4" v-else>Thêm mới người dùng</h1>
        <form @submit.prevent="save()">
          <div class="form-group">
            <label for="userId"
              >Mã người dùng <span style="color: red">*</span></label
            >
            <input
              v-if="user._id"
              readonly
          ...
          <div class="form-group">
            ...
            <select v-model="user.sex" id="sex" class="form-control">
  ...
  methods: {
    ...
    save() {
      ...
      if (this.validate()) {
        ...
        this.$request
          .post("http://localhost:5268/api/admin/users/create", this.user)
          .then((res) => {
            if (res.data.success) {
              this.$router.push({ name: "admin.users" });
            } else {
